...
.star .star-item{
  display:inline-block;background-repeat:no-repeat;width:50px;
  height:50px;
}
...
.star-36 .star-item{width:15px;height:15px;margin-right:10px;background-size:15px 15px;}
...
.star-24 .star-item{width:10px;height:10px;margin-right:5px;background-size:10px 10px;}
