     ...
     <div class="food" v-show="showFlag" ref="food">
          ...
          <div class="info" v-show="food.info">
           ...
           <div class="rating">
            ...
            <ratingSelect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"  @ContentToggle="ContentToggle" @ratingSelect="ratingSelect"></ratingSelect>
